...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    */
    ...
    public void onBackPressed() {
        ...
        if(mainFragment.main_isRunning ){
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.help_Personal_proof:
                intent.setClass(this,PersonalCertification.class);
                startActivity(intent);
                //closeDrawer();
                break;
            ...
            case 1:
                if(grantResults.length>0){
                    if(grantResults[0]== PackageManager.PERMISSION_GRANTED){
                        startDownload(mainFragment.initData.apk_link);
                    }
                }
                break;
        }
        ...
        DownloadService.setOkDownload(new DownloadService.finishDownload() {
            ...
            public void finish(File file) {
                ...
                if(Build.VERSION.SDK_INT>=24){
                    ...
                    Log.d("Jam",Uri.fromFile(file).getAuthority());
                }
